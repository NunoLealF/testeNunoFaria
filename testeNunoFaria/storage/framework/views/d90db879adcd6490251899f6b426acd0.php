...
<html lang="pt">
    ...
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="<?php echo e(asset('icon.png')); ?>">
        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $Produtos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Registo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    
                    <tr>
                        <th scope="row"><?php echo e($Registo->Codigo); ?></th>
                        <td><?php echo e($Registo->Nome); ?></td>
                        <td><?php echo e($Registo->Categoria); ?></td>
                        <td><?php echo e($Registo->Preco); ?></td>
                        <td><?php echo e($Registo->Descricao); ?></td>
                    </tr>
        ...
        <h6 class="fst-italic footer text-center" style="color: gray">
            ...
            <p>
                ...
                <a href="https://www.escola-apel.com/web/">
                    <img src="<?php echo e(asset('icon.png')); ?>" style="height: 16px; padding-left: 0.2em; opacity: 0.5">
                </a>
...
</html><?php /**PATH C:\xampp3\htdocs\testeNunoFaria\resources\views/lista.blade.php ENDPATH**/ ?>